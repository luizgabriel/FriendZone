            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="settings">
                @if ($user->id == Auth::user()->id)
                  <form action="{{ url('profile/{id}/update') }}" class="form-horizontal">
                    ...
                    <div class="form-group">
                      <div class="col-sm-10">
                        <input type="password" class="form-control" id="inputConfirmPassword" placeholder="Confirmar Nova Senha">
                      </div>
                    </div>
                    <div class="form-group">
                ...
                @else
                  <div class="form-group">
                    <div class="col-sm-10">
                      <label>Nome </label><label>{{$user->name}}</label>
                    </div>
                  </div>
                @endif
              </div>
